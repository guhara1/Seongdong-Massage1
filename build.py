#!/usr/bin/env python3
"""바로GO — 성동구 출장마사지·홈타이 안내 사이트 빌드 스크립트.
...
<footer class="site-footer">
  <div class="container footer-grid">
    ...
    <nav class="footer-col" aria-label="지역 안내">
      ...
      <ul>
        <li><a href="/seoul/seongdong/">지역별 안내</a></li>
        <li><a href="/seoul/seongdong/stations/">역세권 안내</a></li>
        <li><a href="/seoul/seongdong/areas/">생활권 안내</a></li>
  ...
  <div class="footer-bottom">
    <div class="container footer-bottom-inner">
      ...
      <div class="footer-cta-group">
        <a class="footer-tg-btn" href="https://t.me/googleseolab" target="_blank" rel="noopener nofollow"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M21.95 4.46 18.7 19.8c-.24 1.08-.88 1.35-1.78.84l-4.92-3.63-2.37 2.28c-.26.26-.48.48-.99.48l.35-5.02L18.1 6.7c.4-.35-.09-.55-.62-.2L6.18 13.62 1.32 12.1c-1.06-.33-1.08-1.06.22-1.57l18.93-7.3c.88-.33 1.65.2 1.48 1.23z"/></svg>웹사이트 제작문의</a>
        <a class="footer-tg-btn" href="https://t.me/googleseolab" target="_blank" rel="noopener nofollow"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M21.95 4.46 18.7 19.8c-.24 1.08-.88 1.35-1.78.84l-4.92-3.63-2.37 2.28c-.26.26-.48.48-.99.48l.35-5.02L18.1 6.7c.4-.35-.09-.55-.62-.2L6.18 13.62 1.32 12.1c-1.06-.33-1.08-1.06.22-1.57l18.93-7.3c.88-.33 1.65.2 1.48 1.23z"/></svg>제휴문의</a>
      </div>
    </div>
  </div>
</footer>
...
def build() -> None:
    ...
    for p, c, r in sorted(report):
        flag = "" if (r == "noindex" or MIN_INDEX_CHARS <= c <= 3000) else "  WARN"
